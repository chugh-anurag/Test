...
namespace Entities
{
    public class IrishCompany : Company, IAddress
    {
        private string employerRegisteredNumber;
        public string EmployerRegisteredNumber  // read-write instance property
        {
            get
            {
                return employerRegisteredNumber;
            }
            set
            {
                employerRegisteredNumber = value;
            }
        }
