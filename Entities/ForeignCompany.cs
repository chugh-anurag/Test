...
namespace Entities
{
    public class ForeignCompany:Company,IAddress
    {
        private string internationBusinessNumber;
        public string InternationBusinessNumber  // read-write instance property
        {
            get
            {
                return internationBusinessNumber;
            }
            set
            {
                internationBusinessNumber = value;
            }
        }
